...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPayments.title'
        db.add_column(u'payments_userpayments', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


        # Changing field 'UserPayments.payment_id'
        db.alter_column(u'payments_userpayments', 'payment_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=120))

    def backwards(self, orm):
        # Deleting field 'UserPayments.title'
        db.delete_column(u'payments_userpayments', 'title')


        # Changing field 'UserPayments.payment_id'
        db.alter_column(u'payments_userpayments', 'payment_id', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
    ...
    models = {
        ...
        u'payments.userpayments': {
            ...
            'payment_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '120'}),
