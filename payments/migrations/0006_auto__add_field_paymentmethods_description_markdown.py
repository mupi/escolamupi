...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentMethods.description_markdown'
        db.add_column(u'payments_paymentmethods', 'description_markdown',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentMethods.description_markdown'
        db.delete_column(u'payments_paymentmethods', 'description_markdown')
