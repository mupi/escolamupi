...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plans.description'
        db.alter_column(u'payments_plans', 'description', self.gf('django.db.models.fields.TextField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Plans.description'
        db.alter_column(u'payments_plans', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))
