...
from payments.views import (AccountPaymentView, CreatePaymentView, PlansView,)
...
urlpatterns = patterns(
    ...
    url(r'^accounts/payment_redirect', CreatePaymentView.as_view(), name="account_payment"),
